    ...
    <div class="card-body">
        <form action="{{ route('admin.courses.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="curriculum" class="form-control" rows="3">{{ old('curriculum') }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="image" class="form-control" value="{{ old('image') }}" placeholder="course-image.jpg">
