...
@section('header-title', 'Create Course')
        ...
        <div class="card-body">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control ckeditor" id="editor-description">{{ old('description') }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <select name="category" class="form-select" required>
                            ...
                            <option value="health" {{ old('category') == 'health' ? 'selected' : '' }}>Health & Community</option>
                            <option value="english" {{ old('category') == 'english' ? 'selected' : '' }}>English (ELICOS)</option>
                            <option value="community" {{ old('category') == 'community' ? 'selected' : '' }}>Community Services</option>
                        </select>
                    </div>
                    <div class="col-md-4 form-group">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" name="fee" class="form-control" value="{{ old('fee', 0) }}" step="0.01" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="study_mode" class="form-control" value="{{ old('study_mode') }}" placeholder="On Campus / Online">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="form-label">Intake Months</label>
                        <input type="text" name="intake_months" class="form-control" value="{{ old('intake_months') }}" placeholder="January, May, September">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label class="form-label">Location</label>
                        <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Sydney, Melbourne">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="form-label">CRICOS Code</label>
                        <input type="text" name="cricos_code" class="form-control" value="{{ old('cricos_code') }}" placeholder="03456J">
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Curriculum</label>
                    <textarea name="curriculum" class="form-control ckeditor" id="editor-curriculum">{{ old('curriculum') }}</textarea>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Instructor</label>
                    <input type="text" name="instructor" class="form-control" value="{{ old('instructor') }}" placeholder="Course coordinator name">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="how_to_apply" class="form-control ckeditor" id="editor-how_to_apply">{{ old('how_to_apply') }}</textarea>
                </div>
                
                <div class="form-group">
                    <label class="form-label">International Student Requirements</label>
                    <textarea name="international_requirements" class="form-control ckeditor" id="editor-international_requirements">{{ old('international_requirements') }}</textarea>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Fees & Payment Plans</label>
                    <textarea name="fees_payment_info" class="form-control ckeditor" id="editor-fees_payment_info">{{ old('fees_payment_info') }}</textarea>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Policies & Forms</label>
                    <textarea name="policies_forms" class="form-control ckeditor" id="editor-policies_forms">{{ old('policies_forms') }}</textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <x-image-upload name="image" label="Course Image" path="courses" />
                    </div>
                    <div class="col-md-6 form-group">
